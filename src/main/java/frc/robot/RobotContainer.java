...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        xboxController.leftBumper().onTrue(Commands.either(s_DrPepper.runLoaderReverseTrough(), s_DrPepper.runLoaderReverse(), () -> s_MrPibb.getState().equals(MrPibbStates.L1.name())).andThen(s_DrPepper.noMoreCoral())).onFalse(s_DrPepper.runUntilFullAlgae());
